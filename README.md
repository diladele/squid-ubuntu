...
**Squid 4.6 Repo for Ubuntu 18**
--------------------------------

If you are installing Squid 4.6 for the first time from diladele.com repo, run the following commands:
